...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-fullname" data-rule="required" class="form-control" name="row[fullname]" type="text" value="<?php echo $row['fullname']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Shortname'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-shortname" data-rule="required" class="form-control" name="row[shortname]" type="text" value="<?php echo $row['shortname']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Manager'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-manager" data-rule="required" class="form-control" name="row[manager]" type="text" value="<?php echo $row['manager']; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-cityid" data-rule="required" class="form-control" name="row[cityid]" type="hidden" value="<?php echo $row['cityid']; ?>" >
            <input id="c-cityidname"  class="form-control"  type="text" value="<?php echo $row['cityidname']; ?>" data-toggle="city-picker" >
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Areaid'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-areaid" data-rule="required" class="form-control" name="row[areaid]" type="hidden" value="<?php echo $row['areaid']; ?>">
            <input id="c-areaidname"  class="form-control"  type="text" value="<?php echo $row['areaidname']; ?>"  data-toggle="city-picker">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Open_time'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-open_time" data-rule="required" class="form-control"  data-use-current="true" name="row[open_time]" type="text" value="<?php echo $row['open_time']; ?>">
        </div>
    </div>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-close_time" data-rule="required" class="form-control"  data-use-current="true" name="row[close_time]" type="text" value="<?php echo $row['close_time']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Address'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-address" data-rule="required" class="form-control" name="row[address]" type="text" value="<?php echo $row['address']; ?>"  data-toggle="addresspicker" data-input-id="c-address" data-lat-id="c-lng" data-lng-id="c-lat">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Lng'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-lng" data-rule="required" class="form-control" name="row[lng]" type="text" value="<?php echo $row['lng']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Lat'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-lat" data-rule="required" class="form-control" name="row[lat]" type="text" value="<?php echo $row['lat']; ?>">
        </div>
    </div>
    <div class="form-group">
    ...
    <!-- <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-parentid" data-rule="required" class="form-control" name="row[parentid]" type="number" value="<?php echo $row['parentid']; ?>">
        </div>
    </div> -->
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select id="c-parentid" data-rule="required" class="form-control selectpicker" name="row[parentid]">
                ...
                <option data-type="<?php echo $vo['id']; ?>" class="" value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['parentid'])?$row['parentid']:explode(',',$row['parentid']))): ?>selected<?php endif; ?>><?php echo $vo['fullname']; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-officeimages" data-rule="required" class="form-control" size="50" name="row[officeimages]" type="text" value="<?php echo $row['officeimages']; ?>">
    ...
    <!-- <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-edit_userid" data-rule="required" class="form-control" name="row[edit_userid]" type="number" value="<?php echo $row['edit_userid']; ?>">
        </div>
    </div> -->
