...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <label for="type-text"><?php echo __('Text'); ?></label>
            <input type="radio" name="row[type]" value="app" id="type-app" />
            <label for="type-app"><?php echo __('App'); ?></label>
        </div>
    </div>
    <div id="expand">
    ...
    <div class="form-group <?php echo input('get.callback')?'':'hidden layer-footer'; ?>">
