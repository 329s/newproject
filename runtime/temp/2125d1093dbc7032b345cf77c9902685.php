...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-vehicle_brand_id" data-rule="required" data-source="vehicle/brand/index" class="form-control selectpage" name="row[vehicle_brand_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Model_series_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-model_series_id" data-rule="required" data-source="model/series/index" class="form-control selectpage" name="row[model_series_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
