...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-identity_id" data-rule="required;max"  class="form-control" name="row[identity_id]" type="text" value="">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-telephone" data-rule="required|mobile" class="form-control" name="row[telephone]" type="text" value="">
        </div>
    </div>
    <!-- <div class="form-group">
