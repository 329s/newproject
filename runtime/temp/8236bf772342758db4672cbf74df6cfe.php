...
<script type="text/javascript">
                ...
                <div id="content">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <?php endif; ?>
                            <div class="content">
                                <form id="edit-form" class="form-horizontal" role="form" data-toggle="validator" method="POST" action="" style="padding-bottom: 150px;">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-start_date" data-rule="required" class="form-control datetimepicker" data-date-format="YYYY-MM-DD" data-use-current="true" name="row[start_date]" type="text" value="<?php echo $row['start_date']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('End_date'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-end_date" data-rule="required" class="form-control datetimepicker" data-date-format="YYYY-MM-DD" data-use-current="true" name="row[end_date]" type="text" value="<?php echo $row['end_date']; ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-is_full_required" data-rule="required" class="form-control selectpicker" name="row[is_full_required]">
                <?php if(is_array($isFullRequiredList) || $isFullRequiredList instanceof \think\Collection || $isFullRequiredList instanceof \think\Paginator): if( count($isFullRequiredList)==0 ) : echo "" ;else: foreach($isFullRequiredList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['is_full_required'])?$row['is_full_required']:explode(',',$row['is_full_required']))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
