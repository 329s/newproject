...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-name" class="form-control" name="row[name]" type="text" placeholder="<?php echo __('Controller/Action'); ?>" value="<?php echo $row['name']; ?>">
        </div>
    </div>
    <div class="form-group">
