...
<script type="text/javascript">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-vehicle_brand_id" data-rule="required" data-source="vehicle/brand/index" class="form-control selectpage" name="row[vehicle_brand_id]" type="text" value="<?php echo $row['vehicle_brand_id']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Model_series_id'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-model_series_id" data-rule="required" data-source="vehicle/brand/index" class="form-control selectpage" name="row[model_series_id]" type="text" value="<?php echo $row['model_series_id']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Vehicle_model'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-vehicle_model" data-rule="required" class="form-control" name="row[vehicle_model]" type="text" value="<?php echo $row['vehicle_model']; ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-vehicle_type" data-rule="required" class="form-control selectpicker" name="row[vehicle_type]">
                <?php if(is_array($vehicleTypeList) || $vehicleTypeList instanceof \think\Collection || $vehicleTypeList instanceof \think\Paginator): if( count($vehicleTypeList)==0 ) : echo "" ;else: foreach($vehicleTypeList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['vehicle_type'])?$row['vehicle_type']:explode(',',$row['vehicle_type']))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-vehicle_flag" data-rule="required" class="form-control selectpicker" multiple="" name="row[vehicle_flag][]">
                <?php if(is_array($vehicleFlagList) || $vehicleFlagList instanceof \think\Collection || $vehicleFlagList instanceof \think\Paginator): if( count($vehicleFlagList)==0 ) : echo "" ;else: foreach($vehicleFlagList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['vehicle_flag'])?$row['vehicle_flag']:explode(',',$row['vehicle_flag']))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-carriage" data-rule="required" class="form-control selectpicker" name="row[carriage]">
                <?php if(is_array($carriageList) || $carriageList instanceof \think\Collection || $carriageList instanceof \think\Paginator): if( count($carriageList)==0 ) : echo "" ;else: foreach($carriageList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['carriage'])?$row['carriage']:explode(',',$row['carriage']))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-seat" data-rule="required" class="form-control selectpicker" name="row[seat]">
                <?php if(is_array($seatList) || $seatList instanceof \think\Collection || $seatList instanceof \think\Paginator): if( count($seatList)==0 ) : echo "" ;else: foreach($seatList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['seat'])?$row['seat']:explode(',',$row['seat']))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-gearbox" data-rule="required" class="form-control selectpicker" name="row[gearbox]">
                <?php if(is_array($gearboxList) || $gearboxList instanceof \think\Collection || $gearboxList instanceof \think\Paginator): if( count($gearboxList)==0 ) : echo "" ;else: foreach($gearboxList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['gearbox'])?$row['gearbox']:explode(',',$row['gearbox']))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-emission" data-rule="required" class="form-control" name="row[emission]" type="number" value="<?php echo $row['emission']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Oil_capacity'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-oil_capacity" data-rule="required" class="form-control" name="row[oil_capacity]" type="number" value="<?php echo $row['oil_capacity']; ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-oil_label" data-rule="required" class="form-control selectpicker" name="row[oil_label]">
                <?php if(is_array($oilLabelList) || $oilLabelList instanceof \think\Collection || $oilLabelList instanceof \think\Paginator): if( count($oilLabelList)==0 ) : echo "" ;else: foreach($oilLabelList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['oil_label'])?$row['oil_label']:explode(',',$row['oil_label']))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
        ...
        <div class="col-xs-12 col-sm-8">
            ...
            <select  id="c-air_intake_mode" data-rule="required" class="form-control selectpicker" name="row[air_intake_mode]">
                <?php if(is_array($airIntakeModeList) || $airIntakeModeList instanceof \think\Collection || $airIntakeModeList instanceof \think\Paginator): if( count($airIntakeModeList)==0 ) : echo "" ;else: foreach($airIntakeModeList as $key=>$vo): ?>
                    <option value="<?php echo $key; ?>" <?php if(in_array(($key), is_array($row['air_intake_mode'])?$row['air_intake_mode']:explode(',',$row['air_intake_mode']))): ?>selected<?php endif; ?>><?php echo $vo; ?></option>
                <?php endforeach; endif; else: echo "" ;endif; ?>
            </select>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <input id="c-poundage" data-rule="required" class="form-control" step="0.01" name="row[poundage]" type="number" value="<?php echo $row['poundage']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Basic_service_charge'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-basic_service_charge" data-rule="required" class="form-control" step="0.01" name="row[basic_service_charge]" type="number" value="<?php echo $row['basic_service_charge']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Rent_deposit'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-rent_deposit" data-rule="required" class="form-control" step="0.01" name="row[rent_deposit]" type="number" value="<?php echo $row['rent_deposit']; ?>">
        </div>
    </div>
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Overtime_price_personal'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <input id="c-overtime_price_personal" data-rule="required" class="form-control" step="0.01" name="row[overtime_price_personal]" type="number" value="<?php echo $row['overtime_price_personal']; ?>">
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-vehicle_model_logo_image" data-rule="required" class="form-control" size="50" name="row[vehicle_model_logo_image]" type="text" value="<?php echo $row['vehicle_model_logo_image']; ?>">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-vehicle_model_main_image" class="form-control" size="50" name="row[vehicle_model_main_image]" type="text" value="<?php echo $row['vehicle_model_main_image']; ?>">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-vehicle_model_left_image" class="form-control" size="50" name="row[vehicle_model_left_image]" type="text" value="<?php echo $row['vehicle_model_left_image']; ?>">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-vehicle_model_right_image" class="form-control" size="50" name="row[vehicle_model_right_image]" type="text" value="<?php echo $row['vehicle_model_right_image']; ?>">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-vehicle_model_front_image" class="form-control" size="50" name="row[vehicle_model_front_image]" type="text" value="<?php echo $row['vehicle_model_front_image']; ?>">
                <div class="input-group-addon no-border no-padding">
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-vehicle_model_back_image" class="form-control" size="50" name="row[vehicle_model_back_image]" type="text" value="<?php echo $row['vehicle_model_back_image']; ?>">
                <div class="input-group-addon no-border no-padding">
